 ...
 * @author Muaad
 */
public class ItemsSoldPanel extends javax.swing.JFrame {

    DefaultTableModel tblModel = new DefaultTableModel();
    String total = "Total items sold for the selected period: ";
    public ItemsSoldPanel() {
        createItemsPanel();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItemsSoldPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ItemsSoldPanel().setVisible(true);
            }
        });
    }
