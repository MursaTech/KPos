 ...
 * @author Muaad
 */
public class StatsTablesPanel extends javax.swing.JFrame {

    DefaultTableModel tblModel = new DefaultTableModel();
    String total = "Total items sold for the selected period: ";
    public StatsTablesPanel() {
        createPanel();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StatsTablesPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StatsTablesPanel().setVisible(true);
            }
        });
    }
